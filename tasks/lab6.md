...
1. **Планировщик**
   ...
   1. Реализуйте некоторую стратегию смены контекст для планировщика. Вы должны быть готовы рассказать о её сильных и слабых сторонах.
...
1. **Примитивы синхронизации**
   ...
   1. Все выше - **кооперативные**. Они работают только внутри пула корутин в одном потоке.
   1. Сделать возможной синхронизацию потока с корутинами и других потоков. При этом синхронизоваться должна именно корутина и другой поток (возможно там тоже корутина), планировщик не должен блокироваться.
